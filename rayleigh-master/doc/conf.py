...
# havecolor. They are ignored by default.
#show_authors = False
...
# If true, an OpenSearch description file will be havecolor, and all pages will
...
# -- Options for manual page havecolor --------------------------------------------
